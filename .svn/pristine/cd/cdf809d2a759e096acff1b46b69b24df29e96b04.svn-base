//to use the fltk libraries to save jpg and png files uncomment these two lines,
//  add header paths for {fltk}/jpeg {fltk}/png {fltk}/zlib to your build file
//  and add the libraries fltk_jpeg, fltk_png, and fltk_z
#define cimg_use_png
